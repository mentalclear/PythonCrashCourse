...
class Battery:
    ...
    def get_range(self):
        """Print a statement baout the range this battery provides"""
...
class ElectricCar(Car):
    """ Represents aspects oof a car, specific to electric vehicles """

    def __init__(self, make, model, year):
        """Initialize attributes of the parent class"""
        super().__init__(make, model, year)
        self.battery = Battery()   # Initializing another class inside.
